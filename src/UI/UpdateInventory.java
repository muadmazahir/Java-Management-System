    ...
    private void updateBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updateBtnActionPerformed
         try{
            ...
            String Query ="UPDATE INVENTORY "
                          + "SET QUANTITY="+Integer.parseInt(quantityTxt.getText())+""
                          + "WHERE ITEMID='"+ItemIDTxt.getText()+"'";         
            stmt.execute(Query);
           
            JOptionPane.showMessageDialog(null,"Quantity Updated Successfully","updated",1); 
